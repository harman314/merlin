...
pub fn show(app: &mut App, ctx: &egui::Context) {
    ...
    egui::Window::new("Update Merlin")
        .id(egui::Id::new("merlin-update"))
        .title_bar(false)
        .resizable(false)
        .auto_sized()
        .frame(frame)
        ...
        .show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                theme::text(ui, "Update Merlin", theme::bold(20.0), palette.text);
            ...
            match &app.update_download {
                ...
                DownloadState::Ready(_) => {
                    ...
                    ui.add(
                        egui::Label::new(
                            RichText::new(
                                "Finish any unsent messages or recordings before restarting. Merlin will briefly disconnect, then reconnect automatically.",
                            )
