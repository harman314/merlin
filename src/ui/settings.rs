        ...
        .show(ui, |ui| {
            Frame::new()
                ...
                .show(ui, |ui| {
                    ...
                    toggle(ui, app, "Keep running when the window closes", "Keep Merlin linked in the system tray. Quit from the tray menu or with Ctrl+Q.", |settings| &mut settings.keep_running_in_background);
                    ...
                    toggle(ui, app, "Check for updates", "Ask GitHub once a day whether a newer Merlin release exists. The request identifies only Merlin and its version.", |settings| &mut settings.check_for_updates);
                    ...
                    widgets::setting_row(
                        ui,
                        &palette,
                        &format!("Merlin {}", env!("CARGO_PKG_VERSION")),
