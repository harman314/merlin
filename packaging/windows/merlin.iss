...
;
;   iscc /DVersion=0.1.0 /DArch=x86_64 /DBinary=...\merlin.exe ^
;        /DOutputDir=dist packaging\windows\merlin.iss
;
...
#define AppName "Merlin"
#define AppExeName "merlin.exe"
...
AppPublisherURL=https://github.com/harman314/merlin
AppSupportURL=https://github.com/harman314/merlin/issues
AppUpdatesURL=https://github.com/harman314/merlin/releases
...
LicenseFile=..\..\LICENSE
OutputDir={#OutputDir}
OutputBaseFilename=merlin-v{#Version}-{#Arch}-pc-windows-msvc-setup
SetupIconFile=merlin.ico
...
Source: "merlin-installer.txt"; DestDir: "{app}"; Flags: ignoreversion


[Icons]
Name: "{autoprograms}\{#AppName}"; Filename: "{app}\{#AppExeName}"; AppUserModelID: "rocks.merlin.Merlin"
Name: "{autodesktop}\{#AppName}"; Filename: "{app}\{#AppExeName}"; Tasks: desktopicon; AppUserModelID: "rocks.merlin.Merlin"
