...
Merlin keeps release asset definitions, nFPM configuration and native AUR
...
See the repository's [maintainer packaging guide](https://github.com/harman314/merlin/blob/main/PACKAGING.md)
