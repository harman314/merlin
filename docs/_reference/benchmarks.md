...
Merlin used **150 MB of idle RAM**, compared with **1.13 GB for WhatsApp Web
...
| Measurement | Merlin 0.13.1 | WhatsApp Web + Chromium |
| --- | ---: | ---: |
...
*The chat-UI observations use different detectors: Merlin's generic “Chats”
...
| Run | Merlin RAM, MiB PSS | Web + Chromium RAM, MiB PSS | Merlin first window | Chromium first window |
| --- | ---: | ---: | ---: | ---: |
...
7.2.3, and Hyprland. Merlin was the installed 0.13.1 release, using real
...
compared with one for Merlin. Neither app had swapped memory in the samples.
...
Merlin is a native WhatsApp client written in Rust for Linux, macOS, and
