---
title: How it links
description: How Merlin links, when it needs the phone, and what it stores locally.
nav_order: 1
---

## A companion device

Merlin registers as a linked device through
...
code. New links list Merlin under **Linked devices**; an existing link may
...
keys will disconnect each other. A second Merlin launch reopens the existing
...
- **History.** WhatsApp replays only recent history to a fresh device.
  Merlin archives new messages and asks the phone for older messages when
...
[Settings & Files](/settings-and-files/) lists their paths. Merlin connects
