---
title: What is Merlin?
description: Why Merlin exists, what it supports, and its current limitations.
redirect_from:
  - /what-is-fastsapp/
nav_order: 0
---
...
WhatsApp has no official Linux app. Merlin is a native WhatsApp client
written in Rust with [egui](https://github.com/emilk/egui). It connects through
[whatsapp-rust](https://github.com/oxidezap/whatsapp-rust). Merlin is a
...
![Merlin showing a chat with a photo, a voice message, and a link preview](/screenshot.png)

## What it does

- **Stores your chats.** Merlin links as a companion device and stores
...
- **Runs in the background.** Closing the window keeps Merlin in the system
...
Merlin does not currently support:
...
When reporting [an issue](https://github.com/harman314/merlin/issues), include
what happened, what you expected, and when it happened. This helps match the
problem to the log in the state directory.

## Account safety

Merlin is an **unofficial** client. Using it may be against WhatsApp's terms
...
Web defines the companion-device model. Merlin is a sibling of
[Spotifast](https://spotifast.rocks), a native client for Spotify.

Merlin is an independent project, not affiliated with or endorsed by
